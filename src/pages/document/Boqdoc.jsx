...
const SaleReturnablesBoqDocs = (props) => {
  ...
  const fetchData2 = async () => {
    ...
    try {
      const response = await fetch(
        `http://192.168.29.223:8080/api/SoRetOrders/${props.newsaleorderBoqId}`
      );
      if (!response.ok) {
        throw new Error("Failed to fetch data");
      }
        ...
        <div className="outer-borderreturnSaleList" id="SalesOrderDoc">
          ...
          <table>
            <tbody>
              ...
              >
                <strong>RETURNABLE SALES ORDER BOQ</strong>
              </h4>
...
export default SaleReturnablesBoqDocs;
