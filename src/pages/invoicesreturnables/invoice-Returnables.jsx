...
const InvoicesReturnables = () => {
  ...
  return (
    <div style={{ margin: "20px" }}>
      <Header
        title="Sales Order Returnables Invoice List"
        subtitle="Check Your Sales Order Invoice Reports Here"
      />
      <Box
...
export default InvoicesReturnables;
