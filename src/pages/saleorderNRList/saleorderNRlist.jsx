...
import SaleNonReturnablesDocs from "../document/SaleNonReturnableDoc";

const SaleOrderNRlist = ({ setDocData }) => {
  // Existing code...
  ...
  return (
    <div style={{ margin: "20px" }}>
      <Header
        title="Non-Returnable SalesOrderList"
        subtitle="Check Your SalesOrder List Here"
      />
        ...
        <DialogContent>
          ...
          {selectedRowDetails && (
            ...
            >
              ...
              />
              <SaleNonReturnablesDocs newsaleorderId={newsaleorderId} />
            </Box>
          )}
        </DialogContent>
        <DialogActions>
...
export default SaleOrderNRlist;
